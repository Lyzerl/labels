...
function renderLabelsTableNoSQL(orders, container, labelsMode = 'all', sortMode = 'distribution') {
  ...
  ordersArray.forEach(order => {
    ...
    const renderLabelSticker = (itemsArray, isTray, traySize = '', currentLabelsMode = 'all') => {
      ...
      html += '<div class="label-card" style="border:2px solid #000 !important;padding:10px !important;background:#fff !important;direction:rtl !important;font-family:Arial,sans-serif !important;page-break-inside:avoid !important;height:140.5mm !important;box-sizing:border-box !important;display:flex !important;flex-direction:column !important;overflow:hidden !important;position:relative !important;">';
